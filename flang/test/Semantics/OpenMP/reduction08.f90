...
program omp_reduction
  ...
  do i=1,10
    !DEF: /omp_reduction/OtherConstruct1/k (OmpShared, OmpReduction) HostAssoc INTEGER(4)
  ...
  do i=1,10
    !DEF: /omp_reduction/OtherConstruct2/k (OmpShared, OmpReduction) HostAssoc INTEGER(4)
  ...
  do i=1,10
    !DEF: /omp_reduction/OtherConstruct3/k (OmpShared, OmpReduction) HostAssoc INTEGER(4)
  ...
  do i=1,10
    !DEF: /omp_reduction/OtherConstruct4/k (OmpShared, OmpReduction) HostAssoc INTEGER(4)
  ...
  do i=1,10
    !DEF: /omp_reduction/OtherConstruct5/k (OmpShared, OmpReduction) HostAssoc INTEGER(4)
