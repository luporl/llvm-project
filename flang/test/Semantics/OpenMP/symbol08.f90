...
!$omp do  collapse(2)
 ...
 do i=1,5
  ...
  do j=6,10
   !DEF: /test_do/OtherConstruct1/a (OmpShared) HostAssoc REAL(4)
   a(1,1,1) = 0.
   !DEF: /test_do/OtherConstruct1/OtherConstruct1/k (OmpPrivate, OmpPreDetermined) HostAssoc INTEGER(4)
   do k=11,15
    !REF: /test_do/OtherConstruct1/a
    !REF: /test_do/OtherConstruct1/OtherConstruct1/k
...
subroutine test_seq_loop
  ...
  !DEF: /test_seq_loop/OtherConstruct1/OtherConstruct1/j (OmpShared) HostAssoc INTEGER(4)
  print *, i, j
  !$omp do
  !DEF: /test_seq_loop/OtherConstruct1/OtherConstruct1/OtherConstruct1/i (OmpPrivate, OmpPreDetermined) HostAssoc INTEGER(4)
  do i=1,10
   !DEF: /test_seq_loop/OtherConstruct1/OtherConstruct1/OtherConstruct1/j (OmpPrivate, OmpPreDetermined) HostAssoc INTEGER(4)
   do j=1,10
   end do
  end do
